                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <button class="btn btn-primary btn-round ms-auto"
                                    onclick="window.location.href='{{ route('testimonials-clients.create') }}'">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{ route('testimonials-clients.edit', $testimonialClient->id) }}"
                                                        ...
                                                        <form action="{{ route('testimonials-clients.destroy', $testimonialClient->id) }}" method="POST" id="delete-form-{{ $testimonialClient->id }}" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
