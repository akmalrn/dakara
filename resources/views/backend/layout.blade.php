...
<head>
    ...
    <title>Wan Teknologi - Admin Dashboard</title>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item {{ Request::is('admin-dashboard/about-us') ? 'active' : '' }}">
            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    ...
                    <div class="copyright">
                        ...
                        <a href="https://wansolution.co.id" target="blank">Wan Teknologi</a>
                    </div>
                    <div>
                        Distributed by
                        <a target="_blank" href="https://wansolution.co.id">WanTek</a>.
                    </div>
                </div>
            </footer>
        </div>
